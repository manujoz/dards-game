...
infer: true
tools: ['read/readFile', 'edit', 'search', 'web/fetch']
---
...
2. **Create Agents**: Design agent files (`.agent.md`) that define specialist assistants with appropriate tools and behaviors
...
1. **Research Phase**: Gather documentation (`web/fetch`), study existing patterns (`search`), analyze deeply
...
- **ALWAYS** write instructions, agents, and prompts in english if not specified otherwise
